...
function test_problems(experiment_tools::ExperimentTools, num_macros::Int, output_folder::String, output::String, mode="best")
...
function main()
    ...
    for mode in ["best", "allow_overlap", "largest"]
